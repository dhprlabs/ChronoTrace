...
target_angles = [0.6, -0.7, 0.2, 3.14, 0, 0]
target_pos, target_quat = forward_kinematics(target_angles)
...
while not glfw.window_should_close(window):
    ...
    angles = inverse_kinematics(target_pos, target_quat, home_key.copy())
    data.qpos = angles
